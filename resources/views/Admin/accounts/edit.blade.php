...
<div class="container" style="max-width:720px; margin:32px auto; padding:0 16px;">
    ...
    <p style="font-size:14px; color:#64748b; margin-bottom:20px;">
        Ubah data akun admin. Kosongkan password jika tidak ingin mengganti.
    </p>
    ...
    <form action="{{ route('admin.accounts.update', $admin->id) }}" method="POST" style="background:#ffffff;padding:24px 20px;border-radius:16px;box-shadow:0 10px 30px rgba(15,23,42,0.08);">
        @csrf
        @method('PUT')
